...
{
    public class ApplicationModeAccess : MultipleDisposable
    {
        public static ApplicationModeAccess Instance => RootAccess.Instance.ApplicationModeAccess;
        ...
        private void FillModeScenesDictionary()
        {
            ...
            RegisterSceneReference(m_ApplicationConfig.Session3DScene, ApplicationMode.Session3D);
            RegisterSceneReference(m_ApplicationConfig.SessionARScene, ApplicationMode.SessionAR);
