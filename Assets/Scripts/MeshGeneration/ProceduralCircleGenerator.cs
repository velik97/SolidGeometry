...
{
    public class ProceduralCircleGenerator : IProceduralMeshGenerator, IHaveMeshSideVisibility
    {
	    ...
	    public void UpdateMesh(Mesh mesh)
	    {
			...
			vertices[middleVertex] = Vector3.zero;
			...
			for (int v = 0; v < verticesCount; v += 1)
			{
