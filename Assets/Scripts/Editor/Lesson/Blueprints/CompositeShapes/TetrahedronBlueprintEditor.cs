...
{
    public class TetrahedronBlueprintEditor: ShapeBlueprintEditor<TetrahedronBlueprint>
    {
        public TetrahedronBlueprintEditor(TetrahedronBlueprint blueprint, Action<ShapeBlueprint, VisualElement> deleteAction) : base(blueprint, deleteAction)
        {
        }
