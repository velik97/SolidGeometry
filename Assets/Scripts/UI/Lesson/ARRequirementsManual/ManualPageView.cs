...
namespace UI.Lesson.ARRequirementsManual
{
    public abstract class ManualPageView<TViewModel> : View<TViewModel>, IManualPageView where TViewModel : ManualPageVM
    {
        ...
        private MultipleDisposable m_ButtonsBindings;
        ...
        public override void Bind(TViewModel viewModel)
        {
            ...
            SetPageLabel();
            AddDisposable(ViewModel.ManualIsCompleted.Subscribe(SetCompletedButton));
        ...
        public void BindButtons()
        {
            ...
            m_ButtonsBindings = new MultipleDisposable();
            m_ButtonsBindings.AddDisposableRange(GetButtonsBindings());
        }
